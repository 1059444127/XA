...
namespace UIH.XR.StateMachineUT
{
    [TestClass]
    public class TestStateMachine
    {
        ...
        public void TestInstantiate()
        {
            ...
            Stream fs = asm.GetManifestResourceStream("UIH.XR.StateMachineUT.SimpleStateMachine.xml");
        ...
        {
            Assembly asm = Assembly.GetExecutingAssembly();
            Stream fs = asm.GetManifestResourceStream("UIH.XR.StateMachineUT.ToggleGateStateMachine.xml");
            IStateMachine sm = new DefaultStateMachineFactory().CreateStateMachineFromXml(fs);
